...
## Pure functions returns objects with pure methods
...
Using of such API is also quite convenient. It behaves like a small assertion-style fluent API, but stays as a pure function.
